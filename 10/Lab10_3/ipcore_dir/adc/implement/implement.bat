...
ngdbuild -uc adc_exdes.ucf adc_exdes

echo 'Running map'
map -timing adc_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm adc_exdes -w routed.ncd routed.v
